...
<div id="banner"><img src="<?php echo (IMG); ?>index_img2.jpg" width="100%" height="191" /></div>
<div id="index_main">
<div id="index_main_img1">
   <a href="<?php echo U('Social/social_buy');?>"><img src="<?php echo (IMG); ?>index_img6.jpg" /></a>
</div>
<div id="index_main_img2"> 
    <a href="<?php echo U('Social/social_buy');?>"><img src="<?php echo (IMG); ?>index_img3.jpg" /></a>
</div>
<div id="index_main_img3">
   <a href="<?php echo U('Socialfare/jisuan');?>"><img src="<?php echo (IMG); ?>index_img4.jpg" /></a>
</div>
<div id="index_main_img4"><img src="<?php echo (IMG); ?>index_img4.jpg" /></div>

</div>
<div id="index_main_middle">
<div class="index_main_middle_div">
<a href="<?php echo U('Search/index');?>">
<img src="<?php echo (IMG); ?>index_img7.jpg" />
</a>
</div> 
<div class="index_main_middle_div">
<a href="<?php echo U('Search/index');?>">
<img src="<?php echo (IMG); ?>index_img9.jpg" height="116" />
</a>
</div>
</div>
  <div id="banner"><img src="<?php echo (IMG); ?>index_img8.jpg" width="100%" /></div>
  <p><li style="font-size:1.5em; color:#000; margin:1em;">职工怎样缴纳养老保险费？</li></p>
</div>
<div id="contbottom">
