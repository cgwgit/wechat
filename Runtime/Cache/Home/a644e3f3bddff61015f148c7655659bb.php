...
<body style="position:relative;font-size: 90%"><div id="app">
...
<div id="shebao_jisuanqi"><span style="font-size: 130%">我的订单</span></div>
...
<div id="content_nav">
  <div id="content_navleft">全部订单</div>
<a href="<?php echo U('norder');?>"><div id="content_navright">待支付</div></a>
</div>
