...
<div class="conttop_divmiddle" style="text-align: center;"><span style="font-size: 130%;">用户名修改</span></div>
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="71%"><input style="width:80%; height:24px; line-height:24px; border-radius:5px; color:#000;" placeholder="请输入您的用户名" type="text" name="username" required/></td>
  </tr>
    <tr>
