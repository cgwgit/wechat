...
<div class="conttop_divmiddle">用户名修改</div>
<div class="conttop_div3"><img src="<?php echo (IMG); ?>zhuce_img4.jpg" /></div>
</div>
<div id="logo"><img src="<?php echo (IMG); ?>zhuce_logo.jpg"  /></div>
<form action="<?php echo U('loginusername');?>" method="post" name="form1">
<div id="centent">
<table width="100%" border="0">
    <tr>
<!--     <td height="31" colspan="2" align="center"><font style="color:#F00;">一旦提交不可更改！</font></td> -->
    </tr>
  <tr>
    <td width="26%" height="29" align="center">用户名：</td>
    <td width="74%"><input style="width:80%; height:24px; line-height:24px; border-radius:5px; color:#000;" placeholder="请输入您的用户名" type="text" name="username" required/></td>
  </tr>
