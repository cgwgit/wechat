...
<div class="conttop_div2"><img src="<?php echo (IMG); ?>xiugaishoujihao.jpg" /></div>
...
<table style="margin:0 auto;" border="0" width="80%">
  <tr>
    <td width="31%">手机号</td>
    <td width="69%"><input style="width:70%; height:24px; line-height:24px;border-radius:6px;" type="text" name="telphone" id="telphone" placeholder="请输入您的原手机号" required="required"/></td>
  </tr>
</table>
</li>
<li>
