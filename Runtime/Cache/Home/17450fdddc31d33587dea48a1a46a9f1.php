...
<table style="background:#FFF; font-size:70%; padding: 0% 2%;" width="100%" border="0">
  ...
  <tr>
   ...
   <ul style="list-style: none; margin:0; padding: 0;">
    ...
    <a href="<?php echo U('editaddress');?>" style="color: black"><li style="list-style: none">投保人信息<span style="color:#F00;">*</span> <span style="float: right;"><?php echo ($area[0]['name']); echo ($area[1]['name']); echo ($area[2]['name']); ?> &nbsp;></span></li>
    </a>
   </td></ul>
  </tr>
     <tr>
