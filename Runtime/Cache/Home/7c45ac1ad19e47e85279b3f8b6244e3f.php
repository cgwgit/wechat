...
<body style="background: #fdb813;font-size: 80%;position:relative;">
<div id="app">
...
<div class="conttop_divmiddle" align="center"><span style="color:white;font-size: 130%;">修改联系人地址</span></div>
...
<form method="post" action="<?php echo U('editaddress');?>">
<div class="acc_apply">
	<ul>
		<li class="clearfix" style="border-top: 0px solid #d6d6d6;">
		  <label class="tl acc_five">修改联系人地址：</label>
...
<input style=" padding:5% 23%; font-size:1em; color:#FFF; background:url(<?php echo (IMG); ?>zhuce_img6.jpg); border:0px;" type="submit" value="保存"/>
</div>
</form>
