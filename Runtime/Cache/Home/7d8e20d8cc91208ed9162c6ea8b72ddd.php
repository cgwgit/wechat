...
<table style="margin:0 auto;" width="98%" border="0">
  ...
  <tr>
    ...
    <td align="right"><?php echo ($chargeinfo['wuxian']); ?>*<?php echo ($chargeinfo['smonths']); ?>个月=<?php echo ($chargeinfo['allcount']); ?></td>
  </tr>
</table>
</div>
...
<div class="conttop_div1" ><a href="javascript:history.go(-1);"style="color: white"><</a></div>
<div class="conttop_div1"></div>
<div id="shezhi_title">公积金收费明细</div>
<div class="conttop_div3"><a style="float:right;" href="###" onclick="openShutManager(this,'box4')"><img src="<?php echo (IMG); ?>zhuce_img4.jpg" /></a>
</div>
</div>
<style type="text/css">
...
<table style="margin:0 auto;" width="98%" border="0">
  ...
  <tr>
    <td height="45" >当前时段费用小计</td>
    <td align="right"><?php echo ($chargeinfo['gjj']); ?>*<?php echo ($chargeinfo['gmonths']); ?>个月=<?php echo ($chargeinfo['gjj']*$chargeinfo['gmonths']); ?></td>
  </tr>
</table>
</div><?php endif; ?>
</div>
