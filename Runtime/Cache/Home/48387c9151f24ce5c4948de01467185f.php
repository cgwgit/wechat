...
<p style=" padding:2% 2%; font-size: 100%;">您正在为<span style="color:#0C3;"><?php echo ($cinfo['cname']); ?></span>参保：</p>
<p style="padding: 1% 2%; background: #FFF; font-size: 100%;">费用明细</p>
<form method="post" action="<?php echo U('Pay/dingdanzhifu');?>">
<table style="background:#FFF; font-size:100%; padding: 0% 2%;" width="100%" border="0">
   <tr>
  ...
  <tr>
    ...
    <a href="<?php echo U('Tinfo/addtinfo',array('cid' => $cid));?>" style="color: black"><li style="list-style: none">投保人信息<span style="color:#F00;">*</span> <span style="float: right;"><?php echo ($tinfo['tname']); ?> &nbsp;></span></li></a>
   </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
<input type="hidden" name="tname" value="<?php echo ($tinfo['tname']); ?>"></input>
...
<p style="text-align:center; padding:30px 0 25px 0; background:#FFF; font-size: 90%;"><input style="background:#F90; padding:10px; " type="submit" value="同意服务协议，立即结算"/></p>
  <a href="<?php echo U('Service/qianchenbaofuwuxieyi');?>" style="color: black;"><p style="text-align: center; padding-top: 5px; background: #FFF; font-size: 80%;">《同意前程保服务协议》</p></a>
</form>
</div>
</body>
</html>