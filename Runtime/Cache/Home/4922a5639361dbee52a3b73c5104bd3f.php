...
<form method="post" action="<?php echo U('Tinfo/addtinfo',array('cid'=>$cid));?>" enctype="multipart/form-data">
<div class="acc_apply">
	<ul>
		<li class="clearfix">
			<label class="tl">投保人姓名：</label>
			<input style="margin-left:14px;" autocomplete="off" placeholder="投保人姓名" class="" name="tname" type="text" />
		</li>
		<li class="clearfix">
		  <label class="tl acc_five">投保人手机：</label>
			<input autocomplete="off" placeholder="投保人手机" class="" name="tel" type="text" />
		</li>
		<li class="clearfix">
		  <label class="tl acc_five">联系邮箱：</label>
			<input autocomplete="off" placeholder="联系邮箱" class="" name="email"type="text" />
		</li>
		<li class="clearfix">
		  <label class="tl acc_five">所在地区：</label>
		...
		<li class="clearfix">
		  <label class="tl acc_five">详细地址：</label>
			<input autocomplete="off" placeholder="详细地址" class="" name="detailarea"type="text" />
		</li>
		<li class="clearfix">
		  <label class="tl acc_five">紧急联系人姓名：</label>
			<input autocomplete="off" placeholder="紧急联系人姓名" class="" name="jname" type="text" />
		</li>
		<li class="clearfix">
		  <label class="tl acc_five">紧急联系人电话：</label>
			<input autocomplete="off" placeholder="紧急联系人电话" class="" name="jtel" type="text" />
		</li>
	</ul>
</div>
