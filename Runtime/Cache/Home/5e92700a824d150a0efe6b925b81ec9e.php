...
<div class="conttop_divmiddle" >姓名修改</div>
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="71%"><input style="width:80%; height:24px; line-height:24px; border-radius:5px; color:#000;" placeholder="请输入您的真实姓名(投保人姓名)" type="text" name="username" required/></td>
  </tr>
    <tr>
