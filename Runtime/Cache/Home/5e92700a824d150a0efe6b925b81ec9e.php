...
<div class="conttop_divmiddle" style="text-align: center;"><span style="font-size: 130%;">姓名修改</span></div>
...
<form action="<?php echo U('editusername');?>" method="post" name="form1">
<div id="centent">
<table width="100%" border="0">
  <tr>
    <td width="29%" height="29" align="center">姓名：</td>
    <td width="71%"><input style="width:80%; height:24px; line-height:24px; border-radius:5px; color:#000;" placeholder="请输入真实投保人姓名" type="text" name="username" required/></td>
  </tr>
    <tr>
