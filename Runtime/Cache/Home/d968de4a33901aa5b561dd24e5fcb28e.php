...
<body style="background: #fdb813;font-size: 100%">
<div id="app" style="font-size: 80%">
...
<div class="conttop_divmiddle" style="text-align: center;"><span style="font-size: 130%;">绑定手机号</span></div>
...
<ul>
<li>
<table style="margin:0 auto;" border="0" width="95%" style="font-size: 80%">
  <tr>
    <td width="31%">新手机号</td>
...
<table style="margin:0 auto;" border="0" width="95%">
  <tr>
    <td width="31%">验证码</td>
    <td width="69%">
        <input style="width:45%; height:24px; line-height:24px; border-radius:6px;" type="text" name="checkcode" placeholder="短信验证码"/>
