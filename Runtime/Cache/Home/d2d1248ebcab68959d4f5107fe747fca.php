...
<div id="shebao_jisuanqi"><img src="<?php echo (IMG); ?>chashebao.jpg" /></div>
<div class="conttop_div3"><img src="<?php echo (IMG); ?>zhuce_img4.jpg" /></div>
</div>
<div id="content">
<div id="chashebao_top">
<div id="chashebao_topleft"><img src="<?php echo (IMG); ?>tu.png" /></div>
<a href="<?php echo U('My/ycperson');?>"><div id="chashebao_topright">前程保查询<br/><p style="font-size: 0.9em; color: #333;">已在前程保缴纳过的用户，可以查询所有的在前程保缴纳记录！</p></div></a>
</div>
<div id="chashebao_hr"></div>
<div id="chashebao_guanfang">
<div id="chashebao_guanfang_left"><img src="<?php echo (IMG); ?>guan.png" /></div>
<a href="http://www.12333sb.com/"><div id="chashebao_guanfang_right">官方查询<p style="font-size: 0.9em; color: #333;">想知道所有的缴纳明细，推荐去各地社保官网查询！</p></div></a>
</div>
<div id="chashebao_hr"></div>
<div id="chashebao_bottom">咨询电话：400-655-6063</div>
</div>
</div>
<style type="text/css">
	  #contbottom {
