...
<div class="conttop_divmiddle" style="text-align: center;"><span style="font-size: 130%;">我的参保人</span></div>
...
<ul>
<?php if(is_array($yperson)): foreach($yperson as $key=>$v): ?><li style="padding: 2% 0">
...
<span style="float: right; color:#3C0;">
<a href="/index.php/Home/Cinfo/editperson/cid/<?php echo ($v["id"]); ?>" style="color:blue">
<img style="float:left; margin-right:8px;" src="<?php echo (IMG); ?>bianji.jpg" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/index.php/Home/Cinfo/delperson/cid/<?php echo ($v["id"]); ?>" style="color:blue">
<img style="float:left;" src="<?php echo (IMG); ?>sahnchu.jpg" /></a>&nbsp;&nbsp;&nbsp; </span>
